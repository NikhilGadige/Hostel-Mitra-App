...
class AdHostelFee extends StatefulWidget {
  AdHostelFee({Key? key}) : super(key: key);

  @override
  _HostelFeeState createState() => _HostelFeeState();
}

class _HostelFeeState extends State<AdHostelFee> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              heightSpacer(55),
              CustomButton(press:(){
                Navigator.push(context, MaterialPageRoute(builder:(context)=>AdminHostelScreen()));
              },
                buttonText: 'Update Fees',
